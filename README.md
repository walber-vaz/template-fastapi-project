...
- 🎯 Entry points to execute your program using `python -m <template_fastapi_project>` or `$ template_fastapi_project` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/walber-vaz/template-fastapi-project/branch/main/graph/badge.svg?token=template-fastapi-project_token_here)](https://codecov.io/gh/walber-vaz/template-fastapi-project)
[![CI](https://github.com/walber-vaz/template-fastapi-project/actions/workflows/main.yml/badge.svg)](https://github.com/walber-vaz/template-fastapi-project/actions/workflows/main.yml)

Awesome template_fastapi_project created by walber-vaz

## Install

from source
```bash
git clone https://github.com/walber-vaz/template-fastapi-project template_fastapi_project
cd template_fastapi_project
make install
```
...
```bash
pip install template_fastapi_project
```

## Executing

```bash
$ template_fastapi_project run --port 8080
```

or

```bash
python -m template_fastapi_project run --port 8080
```

or

```bash
$ uvicorn template_fastapi_project:app
```

## CLI

```bash
❯ template_fastapi_project --help
Usage: template_fastapi_project [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ template_fastapi_project create-user --help
Usage: template_fastapi_project create-user [OPTIONS] USERNAME PASSWORD
...
```bash
template_fastapi_project create-user admin admin --superuser
```
...
```bash
❯ template_fastapi_project shell       
...
Run with `template_fastapi_project run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `template_fastapi_project create-user`.
...
-----------------------------------------------------
template_fastapi_project/__init__.py              4      0   100%
template_fastapi_project/app.py                  16      1    94%
template_fastapi_project/cli.py                  21      0   100%
template_fastapi_project/config.py                5      0   100%
template_fastapi_project/db.py                   10      0   100%
template_fastapi_project/models/__init__.py       0      0   100%
template_fastapi_project/models/content.py       47      1    98%
template_fastapi_project/routes/__init__.py      11      0   100%
template_fastapi_project/routes/content.py       52     25    52%
template_fastapi_project/routes/security.py      15      1    93%
template_fastapi_project/routes/user.py          52     26    50%
template_fastapi_project/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in template_fastapi_project/default.toml.
