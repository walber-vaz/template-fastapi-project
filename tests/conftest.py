...
# WARNING: Ensure imports from `template_fastapi_project` comes after this line
from template_fastapi_project import app, settings, db  # noqa
from template_fastapi_project.cli import create_user, cli  # noqa
